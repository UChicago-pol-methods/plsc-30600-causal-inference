---
title: 'Lab 2: Analayzing Experiments'
date: "2025-01-16"
output:
...
How do we interpret the baseline and interaction terms -- what particular effect does the lower-order coefficient correspond to (and why is it not the ATE)? How do we interpret the interaction term? What do we conclude about whether court deference moderates the effect of the case outcome treatment?
