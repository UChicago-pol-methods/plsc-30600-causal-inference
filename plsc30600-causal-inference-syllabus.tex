...
\item Abadie, Alberto, and Guido W. Imbens. "Large sample properties of matching estimators for average treatment effects." Econometrica 74.1 (2006): 235-267.
\item Abadie, Alberto, and Jann Spiess. "Robust post-matching inference." Journal of the American Statistical Association (2021): 1-13.
\end{itemize}
...
\item Lal, A., Lockhart, M. W., Xu, Y., \& Zu, Z. (2021). How Much Should We Trust Instrumental Variable Estimates in Political Science? Practical Advice based on Over 60 Replicated Studies. \textit{Working Paper.}
\end{itemize}
...
\textbf{Final Exam Assigned May 25th, Due June 2}
...
\item \textbf{Final Exam}: Assigned May 25, Due June 2
\end{itemize}

\section*{Acknowledgments}

This course is indebted to the many wonderful and generous scholars who have developed causal inference curricula in political science departments throughout the world and who have made their course materials available to the public. In particular, I thank Matthew Blackwell, Brandon Stewart, Molly Roberts, Kosuke Imai, Teppei Yamamoto, Jens Hainmueller, Adam Glynn, Gary King, Justin Grimmer whose lecture notes and syllabi have been immensely valuable in the creation of this course. I also thank Andy Eggers and Molly Offer-Westort whose comments and feedback have been essential to the development of this class.
