...
# Percentile interval
quantile(boot_iptw - iptw_est, c(.025, .975))
...
.pull-left[
```{tikz, dag 2, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
\node (x) at (0.5, 1) {$X$};
...
- .maroon[Collider]: $X \rightarrow Y \leftarrow Y$
...
.pull-left[
```{tikz, dag 3, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
\node (x) at (0.5, 1) {$X$};
...
```{tikz, d-separation 2, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
...
```{tikz, d-separation 3, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node[circle, draw]  (x1) at (0,0) {$X_1$};
\node (x2) at (1, 0) {$X_2$};
...
```{tikz, good control, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
...
```{tikz, bad control, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
\node[circle, draw] (m) at (1, -1) {$M$};
...
```{tikz, m bias, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
...
```{tikz, neutral control, echo=F, fig.align='center'}
\usetikzlibrary{arrows}
\begin{tikzpicture}
\node (d) at (0,0) {$D$};
\node[circle, draw] (x) at (1,2) {$X$};
