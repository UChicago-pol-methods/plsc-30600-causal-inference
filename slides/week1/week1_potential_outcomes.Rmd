...
- Logistics:
  - Lectures M/W - 3:00pm - 4:20pm.
  - Sections F - 9:30 - 10:20am
  - 3 Problem Sets (~ 2 weeks)
  - Take-home midterm and final (~ 1 week)
  - My office hours: Tuesdays 1pm-3pm
--
...
# Random variables
  ...
  - A lot of statistical theory revolves around understanding the behavior and properties of .maroon[random variables]
...
--
  ...
  - .maroon[Our estimator:] The sample mean $\hat{\mu} = \bar{Y} = E\left[\frac{1}{n}\sum_{i=1}^n Y_i\right]$
...
# Statistical setup.
  ...
  - Population of units
    - Finite population: $1, 2, \dotsc, N$
    - Superpopulation: $1, 2, \dotsc, \infty$
--
...
--
  - The average treatment effect (ATE): $\tau$
    ...
    $$\tau = E[Y_i(1) - Y_i(0)]$$
--
      - If we consider a finite population of $N$ units, can think of this as
