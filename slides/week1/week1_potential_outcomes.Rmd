...
# Identifying the ATT
  ...
  - Still not enough though. We have an *unobserved* term $[Y_i(0) | D_i = 1]$. Why can't we observe this directly?
...
# Selection-into-treatment bias
  ...
  - Can use theory to "sign the bias" of the difference-in-means.
    ...
    - If we used the difference in turnout between voters who received and voters who did not receive the mailer, would we be over-estimating or under-estimating the effect of treatment? Why?
