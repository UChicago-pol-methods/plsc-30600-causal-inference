...
- Let $D_i$ denote the *assigned* treatment and $S_i$ denote the treatment that is actually taken
  - $D_i$ is randomized but $S_i$ is not.
  - What happens when we analyze the difference between units with observed treatment $S_i = 1$ and observed treatment $S_i = 0$
  
--
- $S_i$ is post-treatment. It has potential outcomes $S_i(d)$. What are those groups?

---

# Principal strata

- We can think of the combination of $S_i$ and $D_i$ as defining a "sub-group" of units -- these are referred to as "principal strata"
...
- Units with $S_i = 1$ could be any three of these strata. Even observing $D_i$ narrows it down to only two - we can't observe the strata directly.
